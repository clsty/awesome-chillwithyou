...
- **仓库**：[qzrs777/AIChat](https://github.com/qzrs777/AIChat)
- **许可**：MIT
- **本地化**：仅中文。
...
- **仓库**：[Small-tailqwq/RealTimeWeatherMod](https://github.com/Small-tailqwq/RealTimeWeatherMod)
- **许可**：MIT
- **本地化**：中文、英文。
- **系统支持**：Windows（支持）；Linux（未知）；MacOS（未知）
- **特性列举**：
...
- **仓库**：[Small-tailqwq/iGPUSaviorMod](https://github.com/Small-tailqwq/iGPUSaviorMod)
- **许可**：MIT
- **本地化**：仅中文。
- **系统支持**：Windows（支持）；Linux（未知）；MacOS（未知）
...
- **仓库**：[Cainongw/ChillMusicInformationSyncMod](https://github.com/Cainongw/ChillMusicInformationSyncMod)
- **许可**：MIT
- **本地化**：仅中文。
- **系统支持**：Windows（支持）；Linux（未知）；MacOS（未知）
